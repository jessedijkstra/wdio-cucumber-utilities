...
exports.config = {
  ...
  cucumberOpts: {
    require: [
      path.join(__dirname, '/steps/given.js'),
      path.join(__dirname, '/steps/then.js'),
      path.join(__dirname, '/steps/when.js'),
    ],                  // <string[]> (file/dir) require files before
                        // executing features
    ...
    strict: false,      // <boolean> fail if there are any undefined or pending
                        // steps
    tags: tagProcessor, // <string[]> (expression) only execute the features or
